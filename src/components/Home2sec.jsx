  ...
  return (
    <div>
        <div className='flex justify-around items-center md:items-start w-[100%] flex-col-reverse md:flex-row mt-24'>
            ...
            '>
            <h1 className='text-[2rem] md:text-[2rem] text-center m-auto mt-16 w-full md:w-[50%] font-semibold'>Introducing Brak & Beyond: Expert Care for Your Pets at Home</h1>
                <li className=''>IncrediPets is your trusted partner for at-home pet care, offering high-quality services that bring the best care right to your doorstep.</li>
