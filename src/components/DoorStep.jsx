...
const DoorStep = () => {
    ...
    return (
        <div>
            ...
            <div onClick={handleClick} className='flex justify-around items-center w-[100%] flex-wrap gap-4 '>
                {card.map((item, index) => (
                    ...
                    <div 
                        key={index} 
                        className='flex flex-col justify-center items-center gap-4 border-2 w-[12rem] h-[11rem] rounded-xl shadow-[0px_20px_30px_-10px_rgb(82 82 82)]' 
